...
import apiRoutes from './backend/routes/api.js'; // Route imports
import errorHandler from './backend/middleware/error.js'; // Error handler
...
const corsOptions = {
  origin: process.env.NODE_ENV === 'production' 
    ? [process.env.FRONTEND_URL || 'https://pesaboost.vercel.app'] 
    : ['http://localhost:3000', 'http://localhost:3001', process.env.FRONTEND_URL || 'https://pesaboost.vercel.app'], // Allow both local and production origins
