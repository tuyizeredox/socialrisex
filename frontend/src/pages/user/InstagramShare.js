...
export default function InstagramShare() {
  ...
  const downloadPhoto = (photo) => {
    ...
    link.download = `pesaboost-instagram-${photo._id}.jpg`;
  ...
  const getInstagramCaption = () => {
    if (!selectedPhoto) return '';
    return `🌟 Check out this amazing photo from Pesa Boost! 📸\n\n` +
      ...
      `#PesaBoost #EarnMoney #InstagramShare #MakeMoneyOnline #PassiveIncome`;
  };
